      ...
      <div className="project-container-grid">
        <div className="project-item">
          <div className="project-image">
            <img src="src/assets/WordCloud.png" alt="Wikipedia Word Cloud" />
          </div>
        ...
        <div className="project-item">
          <div className="project-image">
            <img src="src/assets/Homelab.png" alt="Homelab Server" />
          </div>
          <div className="project-description">
        ...
        <div className="project-item">
          <div className="project-image">
            <img src="src/assets/BugCatch.png" alt="Bug Catcher Game" />
          </div>
          <div className="project-description">
